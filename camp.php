...
function call($url){
                ...
                $list = json_decode(call("https://cpalead.com/dashboard/reports/campaign_json.php?id=2207054&format=JSON&country=IN&device=android&subid=$phone"));
                $a = 0;
                $aa = $list->number_offers;
 ?>
<!DOCTYPE html>
<html lang="en">
              ...
              <div class="card h-100">
                ...
                <div class="card-body">
                  ...
                  <div class="row align-items-center">
                  	<img src="'.$list->offers[$a]->creatives["0"]->url.'" style="border-radius: 100%; height: auto; width: 2rem" alt="image">
                    <div class="col mr-2">
                    	
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Offer</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">'.$list->offers[$a]->title.'</div>
                      
                      <div class="mt-2 mb-0 text-muted text-xs">
              Reward : ₹'.currency($list->offers[$a]->amount).'
                      Id : '.$list->offers[$a]->campid.'
                      Type : '.$list->offers[$a]->payout_type.'<br>
                      Description : '.$list->offers[$a]->description.' '.$inr.'
                      </div>
                    </div>
                    <div class="col-auto">
                   <a href="'.$list->offers[$a]->link.'">   <i class="fas fa-arrow-alt-circle-right fa-2x text-info"></i></a>
                    </div>
                  </div>
                </div>
              </div>
