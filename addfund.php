...
if(mysqli_num_rows($run) >= 1 ){
	$error = '<div style="width: 20rem; margin: auto; padding: 1.1rem;"><div class="alert alert-danger alert-dismissible" role="alert">
             ...
             $key = ""; // Add Merchant Id From Paytm
...
<div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Add Fund</h6>
                </div>
                <?= $error; ?>
                <img src="img/pay.jpg" style="height: auto; width: 15rem; margin: auto; border: 1px solid #000000;">
                <br>
               <div style="border: 1px solid #000000; width: 20rem; margin: auto; padding: 1.1rem; border-radius: 3px;"> 
             <b >   	Pay On Above QR Using <img src="img/download.jpg" style="height: auto; width: 2.5rem;"> Or <img src="img/download.png" style="border-radius: 100%; height: auto; width: 2.5rem;"> And Submit Transection Id Below </b>
                ...
                <br>
                	...
                	<div class="form-group">
                      <input type="text" class="form-control" id="exampleInputPassword" placeholder="Enter Order Id / Transaction Id" name="oid" required>
                      <div>
                      <br>
                      <div class="form-group">
