...
<div class="col-lg-12">
              <div class="card mb-4">
                ...
                <?= $error; ?>
                	...
                	<form method="POST" action="rlget.php">
                	<div class="form-group">
                      <input type="url" class="form-control" placeholder="Enter Redirect Link" name="link" required>
                      <div>
                      <br>
                      <div class="form-group">
                      <button type="submit" class="btn btn-primary btn-block" name="submit">Get Code</button>
                    </div>
                      </form>
                    </div>
                </div>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Your rl Codes</h6>
                </div>
                <div class="table-responsive">
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      <tr>
                      	<?php
$sql = "SELECT * FROM `rlcode` WHERE user='$user'";
