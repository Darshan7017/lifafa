...
if(!$user){
$error ='
          <div style="width: 20rem; margin: auto; padding-bottom: 0.0000005rem; !important"><div class="alert alert-danger alert-dismissible" role="alert">
...
$link = $_POST['link'];
$num0 = (rand(10000,99999));
    $num1 = (rand(10000,99999));
    $pin = $num0 . $num1;
$query="SELECT * FROM rlcode WHERE code='$pin'";
    $run = mysqli_query($conn,$query);
       if(mysqli_num_rows($run) >= 1 ){
       	$error = '<div style="width: 20rem; margin: auto; padding: 1.1rem;"><div class="alert alert-danger alert-dismissible" role="alert">
                  ...
                  $pin = "Unknown Error Occurred";
       	}else{
       	$sql = "INSERT INTO rlcode (user,code,link)
values ('$user','$pin','$link')";
 $result = mysqli_query($conn, $sql);
 if($result){
 	$error = '<div style="width: 20rem; margin: auto; padding: 1.1rem; padding-bottom: 0.0000005rem; !important"><div class="alert alert-success alert-dismissible" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                    Code Created Successful 
                  </div></div>';
 } else {
...
<div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">rl Code Generater</h6>
                </div>
                <?= $error; ?>
                	...
                	<div class="form-group">
                      <input type="text" class="form-control" value="<?= $pin; ?>" id="myInput">
                      <div>
                      <br>
                      <div class="form-group">
                      <button type="button" class="btn btn-primary btn-block" onclick="myFunction()">Copy Code</button>
                    </div>
