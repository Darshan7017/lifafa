            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="card mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Lifafa History</h6>
                </div>
                ...
                <div class="table-responsive">
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
       <?php
$sql = "SELECT * FROM lifdata WHERE user='$user'";
...
?>
                     ...
                     <td><?= $id; ?></a></td>
                        ...
                        <td><?= $adv; ?></td>
                        <td><?= $rae; ?></td>
                        <td><a href="lifedit.php?id=<?= $id; ?>"><button type="button" class="btn btn-primary mb-1">Edit</button></a></td>
                      </tr>
               <?php  } ?>
                    </tbody>
                  </table>
