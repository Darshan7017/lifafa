...
<div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Create Lifafa</h6>
                </div>
                <?= $error; ?>
                	<div style="width: 20rem; margin: auto; padding: 1.1rem;">
              <form method="POST" action="lifafadone.php" id="lifafaform">            
            ...
            <option value="normal">Normal Lifafa</option>
            <option value="dice">Dice Lifafa</option>
                    </select>
                  </div>
                      <div class="form-group">
                      <input type="text" class="form-control" placeholder="Enter Title Name" name="title" required>
                      </div>
                      <div class="form-group">
                      <input type="text" class="form-control" placeholder="Enter Promotion Link" name="link">
                      </div>
                      <div class="form-group">
                      <input type="number" class="form-control" placeholder="Enter Total User" name="tamo" required>
                      </div>
                      <div class="form-group">
                      <input type="number" class="form-control" placeholder="Enter Per User Amount" name="pamo" required>
                      </div>
                      <div class="form-group">
                      <input type="text" class="form-control" placeholder="Enter Payment Comment" name="com" required>
                      </div>
                      <div class="form-group">
                      <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" id="acode" name="iscode">
                        <label class="custom-control-label" for="acode">Access Code</label></div>
                      
                      </div>
                      <div id="code1" hidden>       
<div class="form-group">           
                      <input type="text" class="form-control" placeholder="Enter Access Code" name="code">
                    </div>          
                    </div>
                    <script>
...
checkbox.addEventListener("click", (e) => { 
 ...
 <div class="form-group">
                      <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" id="refer" name="isrefer">
                        <label class="custom-control-label" for="refer">Refer And Earn</label></div>
                      
                      </div>
                      <div id="refern" hidden>       
<div class="form-group">           
                      <input type="number" class="form-control" placeholder="Enter Per Refer" name="prefer">
                    </div>          
                    <div class="form-group">           
                      <input type="text" class="form-control" placeholder="Enter Refer Comment" name="rcomment">
                    </div>          
                    </div>
                    <script>
const referbox = document.querySelector("#refer"); 
const rskills = document.querySelector("#refern"); 
referbox.addEventListener("click", (e) => { 
  rskills.hidden = !e.target.checked; 
}); 
</script>                           
                    <div class="form-group">
                      <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" id="adv" name="isuname">
...
<div class="bg-gradient-info" style="border: 1px solid #000000; width: 17.8rem; margin: auto; padding: 1.06rem; border-radius: 3px; color: #ffffff;"> 
             <b >   	<div>By Using This Feature
Member Have To Join You Channel To Claim</div>
<br><p>Enter Channel Username Without @. Ex:- yourusername</p>  <div> You Can Preset Your Channels In Settings </div> </b>
...
checkbox1.addEventListener("click", (e) => { 
  skills1.hidden = !e.target.checked; 
                      ...
                      <button type="submit" class="btn btn-primary btn-block" name="submit">Create Lifafa</button>
                    </div>
                      </form>
                    </div>
                </div>
  ...
  <script src="js/demo/chart-area-demo.js"></script>  
    <script>
    	$("#lifafaform").submit(function(e) {
    e.preventDefault(); 
    $("#sub").html('<button type="button" class="btn btn-primary btn-block" name="submit"><i class="fa fa-spinner fa-spin"></i> Creating Lifafa</button>');
    var form = $(this);
   ...
   $("#lifafadata").html(data);
    $('#exampleModal').modal('show');
    $("#sub").html('<button type="submit" class="btn btn-primary btn-block" name="submit">Create Another Lifafa</button>');
        }});
