...
ob_start();
include "lib.php";
define('API_KEY','5625439533:AAFZwx1iwpMW62ttbfdxjjCCryeBIYUqjcE');
//tokenni yozing
$admin = "1516610662";
...
Message($from_id,"<b>🔥 Hello $ufname  🔥\n\n😎 Welcome to the Verifier Bot 😎</b>");
inlinekeyboard($from_id,"<b>👇 Click ♻️ Open Link to Claim Lifafa</b>",[[["text"=>"♻️ Open Link","url"=>"https://localhost:8080/Web/redirect.php?id=$id&tk=$from_id"]]]);
}
else{
Message($from_id,"<b>🔥 Hello $ufname🔥\n\n😎 Welcome to the Verifier Bot 😎\n\n☑️ Join @deadlylooters 🚨\n\n🌀You are Not Redirected from Website 🌀</b>");

  inlinekeyboard($from_id,"<b>☑️Join Our Offical Channel (For More Update )</b>",[[["text"=>"🔥 Join Channel","url"=>"https://t.me/deadlylooters"]]]);
   }
}
