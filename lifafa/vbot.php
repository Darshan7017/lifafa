...
ob_start();
include "lib.php";
define('API_KEY','6172365321:AAFJ2E4T_EJDEcdUNyD7FuAfS2QTu6jUhww');
//tokenni yozing
$admin = "1516610662";
...
Message($from_id,"<b>🔥 Hello $ufname  🔥\n\n😎 Welcome to the Bot Alert Bot 😎</b>");
inlinekeyboard($from_id,"<b>👇 Click ♻️ Open Link to Set Bot Alert</b>",[[["text"=>"♻️ Open Link","url"=>"https://fastback.in/dashboard.php?id=$id&tk=$from_id"]]]);
}
else{
Message($from_id,"<b>🔥 Hello $ufname🔥\n\n😎 Welcome to the Alert Bot 😎\n\n☑️ Join @fastback_lifafa 🚨\n\n🌀You are Not Redirected from Website 🌀</b>");

  inlinekeyboard($from_id,"<b>☑️Join Our Offical Channel (For More Update )</b>",[[["text"=>"🔥 Join Channel","url"=>"https://t.me/fastback_lifafa"]]]);
   }
}
